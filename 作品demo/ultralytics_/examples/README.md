...
| [YOLO OpenCV ONNX Detection Python](./YOLOv8-OpenCV-ONNX-Python)          1                                                               | OpenCV/Python/ONNX | [Farid Inawan](https://github.com/frdteknikelektro)                                       |
...
| [YOLOv8 on NVIDIA Jetson(TensorRT and DeepStream)](https://wiki.seeedstudio.com/YOLOv8-DeepStream-TRT-Jetson/)    1  嵌入式和边缘计算             | Python             | [Lakshantha](https://github.com/lakshanthad)                                              |
| [YOLOv8 ONNXRuntime Python](./YOLOv8-ONNXRuntime)                  1                                                                      | Python/ONNXRuntime | [Semih Demirel](https://github.com/semihhdemirel)                                         |
...
| [YOLOv8 SAHI Video Inference](https://github.com/RizwanMunawar/ultralytics/blob/main/examples/YOLOv8-SAHI-Inference-Video/yolov8_sahi.py) | Python       1     | [Muhammad Rizwan Munawar](https://github.com/RizwanMunawar)                               |
...
| [YOLOv8 OpenCV INT8 TFLite Python](./YOLOv8-OpenCV-int8-tflite-Python)           1 tflite部署在移动端                                           | Python             | [Wamiq Raza](https://github.com/wamiqraza)                                                |
